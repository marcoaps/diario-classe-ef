...
export interface OpcoesHtmlProva {
  /** Nome do professor a exibir no cabeçalho — se omitido, mantém o texto padrão atual ("Marco Pedro"). */
      ...
      <table style="width:100%;border:2px solid #1e3a5f;border-radius:4px;margin-bottom:6px;border-collapse:collapse;">
        <tr>
          ...
          <td style="padding:6px;vertical-align:middle;">
            ...
            <div style="font-size:10pt;margin-bottom:1px;">Disciplina: <strong>Educa&#231;&#227;o F&#237;sica</strong> &nbsp;&nbsp; Professor(a): <strong>${escaparHTML(professorNome)}</strong></div>
