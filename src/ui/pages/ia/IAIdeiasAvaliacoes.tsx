...
// Reativado a pedido do usuário: imagem ajuda especificamente esse público
// (NEE), mesmo com a busca desligada nas outras telas (Gerador de Questões
// e Sequência Didática) — só o Pexels é usado aqui, sem custo de IA.
