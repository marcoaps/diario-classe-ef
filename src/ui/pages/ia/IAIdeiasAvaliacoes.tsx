...
import { ArrowLeft, Sparkles, Loader2, RefreshCw, Printer, FileText, Copy, Check } from 'lucide-react';
    ...
    <div className="py-4 space-y-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-on-surface-variant">7 questoes visuais com espaço pra você inserir a imagem depois</p>
        </div>
      </div>
