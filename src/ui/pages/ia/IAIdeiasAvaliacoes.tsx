...
export function IAIdeiasAvaliacoes() {
  ...
  // Commons): uma linha pequena no fim da prova, sem repetir o mesmo crédito.
  function creditosHtmlStr(): string {
    ...
    return `<div style="margin-top:8px;font-size:7pt;color:#64748b;">${texto}</div>`;
  }
  ...
  function imprimir() {
    ...
    const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>E.E.E. Fundamental - Instituto Odilon Pratagi - 2026</title><style>${css}</style></head><body>${cabecalhoHtml(nome)}${questoesHtmlStr()}${creditosHtmlStr()}<script>setTimeout(function(){window.print();},600);<\/script></body></html>`;
