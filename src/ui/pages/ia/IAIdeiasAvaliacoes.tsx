...
import { buscarImagemPexels } from './sequenciaDidaticaImagens';
...
export function IAIdeiasAvaliacoes() {
  ...
  async function gerar() {
    ...
    try {
      ...
      // Confere se a foto realmente é do esporte certo (a legenda do Pexels
      // às vezes traz o esporte errado pra queries parecidas) — mesma
