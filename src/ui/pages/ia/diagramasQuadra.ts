...
export const DIAGRAMAS_QUADRA: ItemBancoImagem[] = [
  ...
  item('zona-substituicao', 'Zona de substituição destacada', [...TAGS_QUADRA, 'zona de substituicao', 'substituicao', 'troca', 'banco', 'reserva'], quadraInteira({ destaque: 'substituicao' })),
