...
export function useCardsRodizio(chave: string) {
  ...
  return {
    ...
    registrarJogo: (aId: string, bId: string, placarA?: unknown, placarB?: unknown) => aplicarEstado(e => L.registrarJogo(e, aId, bId, placarA, placarB)),
    editarPlacar: (numero: number, placarA: unknown, placarB: unknown) => aplicarEstado(e => L.editarPlacar(e, numero, placarA, placarB)),
